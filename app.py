...
st.markdown('<div style="background-color: rgba(241, 196, 15, 0.8); padding: 20px; border-radius: 10px; color: black; font-weight: bold; font-family: sans-serif; font-size: 15px;">Please enter your text in the field below</div>', unsafe_allow_html=True)
